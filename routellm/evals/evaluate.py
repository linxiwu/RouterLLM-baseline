...
from routellm.evals.benchmarks import ARC, MATH, OpenBookQA
...
if __name__ == "__main__":
    ...
    print("Running eval for ARC.")
    benchmark = ARC(controller.model_pair, args.overwrite_cache)
elif args.benchmark == "math":
    print("Running eval for Math.")
    benchmark = MATH(controller.model_pair, args.overwrite_cache)
elif args.benchmark == "openbookqa":
    print("Running eval for OpenBookQA.")
    benchmark = OpenBookQA(controller.model_pair, args.overwrite_cache)
else:
